	...
	<body>
		...
		<div class="container-fluid p-0">
			...
			<div class="container-fluid">
				...
				<div class="row bg-secondary vh-100 p-5">
					
					<form class="m-auto p-5 rounded" method="POST" action="LoveBirdSignIn">
						...
						<div class="form-group">
							<input name="username" class="form-control form-control-lg" type="text" placeholder="Username" id="inputLarge1">
						</div>
						
						<div class="form-group">
							<input name="password" class="form-control form-control-lg" type="password" placeholder="Password" id="inputLarge2">
						</div>
						
						<c:forEach items="${errorsForInputsSignIn}" var="errors">
							<h6 class="text-danger d-inline mt-4 mb-4">${errors}</h6>
							<br/>
						</c:forEach>
						
						<h6 class="text-danger d-inline mt-4 mb-4">${validUserCredentials}</h6>
						<br/>
						
						<button type="submit" class="btn btn-outline-secondary mt-3">Sign In</button>
